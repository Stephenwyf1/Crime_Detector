...
parser.add_argument('output_json', default='./output/detection_result_VAD.json',type=str)
parser.add_argument('gt_json', type=str, default='./thumos_annotations/thumos_gt_VAD.json', nargs='?')
...
anet_detection = ANETdetection(
    ...
    subset='test', tiou_thresholds=tious,verbose=True)
